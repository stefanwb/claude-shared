...
3. Review via `claude-shared:tech-lead` (or `/code-review low` when the session model is Opus). Fewer, high-confidence findings beat broad speculative ones.
